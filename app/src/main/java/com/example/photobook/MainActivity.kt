...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var btnStartSavedPostsActivity: Button
    ...
    private fun setupListeners() {
        btnStartSavedPostsActivity.setOnClickListener {
            startActivity(
    ...
    private fun initViews() {
        ...
        postAdapter.onPostClickListener = AllPostsOnClickListener()

        btnStartSavedPostsActivity = findViewById(R.id.btnStartSavePostActivity)
    ...
    inner class AllPostsOnClickListener : PostsAdapter.OnPostClickListener {
        ...
        override fun onLikeClicked(id:Int,position: Int) {
            mt("MA: post at $position clicked")
        }
    }
